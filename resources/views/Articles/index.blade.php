        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <div class="float-sm-right text-zero">
                    <a href="{{ route('Articles.create') }}" class="btn btn-primary btn-lg top-right-button mr-1 text-white">ADD NEW</a>
            ...
            <div class=" rounded card d-flex flex-row mb-3">
                <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                    <div class="header-large card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                        ...
                        <h6 class="mb-1 w-10 w-sm-100 ">Nom</h6>
                        <h6 class="mb-1 w-10 w-sm-100 text-center">Prix</h6>
                        <h6 class="mb-1 w-10 w-sm-100 text-center">Taxes</h6>
                        <h6 class="mb-1 w-15 w-sm-100 text-center">Qte</h6>
                        <h6 class="mb-1 w-15 w-sm-100">Catégorie</h6>
                    </div>
                </div>
            </div>
                ...
                <div class="card d-flex flex-row mb-3">
                    ...
                    <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                        <div class="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                            <a href="{{ route('Articles.show', $article ) }}" class="w-20 w-sm-100">
                            ...
                            <div class="w-15 w-sm-100">
                                <span class="badge badge-pill {{ $article->qteInStock > 0 ? ($article->qteInStock <= 5 ? 'badge-warning' : 'badge-primary') : 'badge-danger' }} text-extra-small">{{ (int)$article->qteInStock }} dans le stock</span>
                            </div>
